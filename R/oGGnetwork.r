...
#' ig <- igraph::induced_subgraph(g, vids=nodeInduced)
#'
...
#' dag_ig <- igraph::induced_subgraph(dag, vids=which(V(dag)$num_approved>=20))
...
#' dag_ig <- igraph::induced_subgraph(dag_ig, vids=nodeInduced)
